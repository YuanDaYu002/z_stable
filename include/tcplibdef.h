...
#ifdef HAY_DEBUG
	#define TCP_PRINTF(fmt, args...) printf( "\033[1;32m             NETLIB TCP DEBUG(%s:%d):             \033[0m" fmt, __func__, __LINE__, ## args)

#else
	#define TCP_PRINTF(fmt, args...) 
#endif

#define ERR_TCP(fmt, args...) printf("\033[1;31m             NETLIB TCP RROR(%s:%d):             \033[0m" fmt, __func__, __LINE__, ## args)
...
//支持的最大客户端最大数量
#define MAX_NET_TCP_USER			32
//支持的最大视频播放数量
#define MAX_MEDIA_PLAYER			16

#define TCP_RECV_BUF_SIZE			512*1024
